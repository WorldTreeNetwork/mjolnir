...
[`add-host-sidecar-redis`](../../changes/archive/2026-08-25-add-host-sidecar-redis/proposal.md)
on 2026-08-25. ADR
[`0007`](../../../docs/decisions/0007-host-sidecar-redis.md).

## Purpose

Durable Redis on `:host_api_ip:6379` for guest apps (first:
Hypersigil Medusa sessions). systemd, not an OTP Port. Not a hotel.
...
MAY exist for host `redis-cli` and SHALL NOT be mounted into guests.
