...
door streams to host SSD (`/var/lib/mjolnir/blobs`, outside
`btrfs_root`) and write-throughs to B2; 1 TiB safety rail, 64 GiB
cache budget. Do not send GiB through `deliver_message`.
